...
<?php
	...
	<P class= "mom" size="40">MOM</p>
		...
		<div class="showcase" style="margin-top: -90px; margin-left: 25px;">
			<h1 style="margin:5px 5px; padding: 5px 5px; letter-spacing: 0.2em;">Gift Cards For Mom</h1>
			<p style="margin:5px 5px; padding:0px 5px 15px 5px;font-size: 20px;">You simply buy mom a gift card and let her
				make all of those 
				decisions for herself. If you're not sure which gift card to buy, then look at this list.
				Get a gift card to a sporting cards store like  <strong> "Heart and Soul" </strong>. The cards bring mothers closer. As the 
			...
			<div class=sub-grid4 style="background-image:url(images/abstract.jpg); background-size:cover;margin-top: 0px;">
				...
				$query = "SELECT * FROM products WHERE category='Mom'";
