...
if($_SESSION['username']=='admin'){
	...
	<body>
		...
		<div class="showcase" style="margin-top: -170px;"> 
			...
			<table style="margin-left: 40px; margin-top: 0px;font-family: timesnewroman; color: green; border: 2px solid black;">
				<tr style="border: 2px solid black;">
					<th style="font-size: 25px;">Name</th>
					<th style="font-size: 25px;">Phone</th>
					<th style="font-size: 25px;">Address</th>
					<th style="font-size: 25px;">E-mail</th>
					<th style="font-size: 25px;">Message</th>
					<!-- <th style="font-size: 25px;">Contact</th> -->
					<th style="font-size: 25px;">Card</th>
					<th style="font-size: 25px;">Delivery Mode</th>
				</tr>
				...
				while ($result = mysqli_fetch_assoc($data)) {
					...
					<td><div style='margin:20px;font-size:25px;color:black'>".$result['message']."</div></td>

					<td><div style='margin:20px;font-size:25px;color:black'>".$result['cardselected']."</div></td>
					<td><div style='margin:20px;font-size:25px;color:black'>".$result['deliverymode']."</div></td>
					</tr>";
