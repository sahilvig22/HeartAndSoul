<?php
	...
	<P class= "mom" size="40">DAD</p>
		...
		<div class="showcase" style="margin-top: -90px; margin-left: 25px;">
			<h1 style="margin:5px 5px; padding: 5px 5px; letter-spacing: 0.2em;">Gift Cards For Dad</h1>
			<p style="margin:5px 5px; padding:0px 5px 15px 5px;font-size: 20px;">If you are looking for a fun gift to get dad or grandpa on Father's Day, then this is the right place.If you're not sure which gift card to buy, then look at this list.
                    Get a gift card to a sporting cards store like  <strong> "Heart and Soul" </strong>. The cards bring fathers closer. As the 
			...
			<div class=sub-grid4 style="background-image:url(images/abstract.jpg); background-size:cover;margin-top: 0px;">
				...
				$query = "SELECT * FROM products WHERE category='Dad'";
