...
<form method="GET" class="loginform" style="background-image:url(images/abstract.jpg); background-size:cover;">
		<br>
    ...
    if ($_GET['btnlogin']) {
         ...
         if ($password == '') {
          ...
          if ($loginas == "admin") {
            ...
            $query = "SELECT * FROM admin_login WHERE email = '$email' && password = $password ";
