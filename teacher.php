<?php
	...
	if($_SESSION['username']=='user'){
		...
		<html>
		<head>
			<title>Teacher Gift Cards</title>
		</head>
		<body>
			<table>
		<tr>
	...
	<P class= "mom" size="40">Teacher</p>
		...
		<div class="showcase" style="margin-top: -90px; margin-left: 25px;">
			<h1 style="margin:5px 5px; padding: 5px 5px; letter-spacing: 0.2em;">Gift Cards For Teacher</h1>
			<p style="margin:5px 5px; padding:0px 5px 15px 5px;font-size: 20px;">For Teacher Appreciation Week and any other day of the year. Don't think twice, just speak your heart out. Get a gift card to a sporting cards store like  <strong> "Heart and Soul" </strong>. The cards bring teachers closer. As the 
			...
			<div class=sub-grid4 style="background-image:url(images/abstract.jpg); background-size:cover;margin-top: 0px;">
				...
				$query = "SELECT * FROM products WHERE category='Teacher'";
