<?php
	...
	<P class= "mom" size="40">LOVER</p>
		...
		<div class="showcase" style="margin-top: -90px; margin-left: 25px;">
			<h1 style="margin:5px 5px; padding: 5px 5px; letter-spacing: 0.2em;">Gift Cards For Lover</h1>
			<p style="margin:5px 5px; padding:0px 5px 15px 5px;font-size: 20px;">With these beautiful love cards say something special to your sweetheart. Don't think twice, just speak your heart out. Get a gift card to a sporting cards store like  <strong> "Heart and Soul" </strong>. The cards bring lovers closer. As the 
			...
			<div class=sub-grid4 style="background-image:url(images/abstract.jpg); background-size:cover;margin-top: 0px;">
				...
				$query = "SELECT * FROM products WHERE category='Lover'";
