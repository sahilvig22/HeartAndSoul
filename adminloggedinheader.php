...
<body style="font-family: 'Pacifico', cursive;">
    ...
    <nav id="navbar" style="position: relative;">
        ...
        <ul>
            ...
            <li><a href="adminloggedin.php" class="nav-neon , navbarhover" style="margin-top: 100px;">User List</a></li>

            <li><a href="uploadproduct.php" class="nav-neon , navbarhover" style="margin-top: 100px;">Upload Product</a></li>

            <li><a href="enquiry.php" class="nav-neon , navbarhover" style="margin-top: 100px;">Enquiries</a></li>

            <li><a href="orders.php" class="nav-neon , navbarhover" style="margin-top: 100px;">Orders</a></li>
